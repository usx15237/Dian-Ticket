$(document).ready(function() {
  ...
  var busy = false;
  var cardsCreated = 0;
  var $notched = $('.demo__card--notched');
  var $controls = $('.demo__controls');
  var $cards = $('.demo__card');
  var $regularCards = $('.demo__card--regular');
  var $timeIndicator = $('.demo__indicator--time');
